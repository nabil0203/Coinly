      ...
      >
        {currentBalance === 0 && (
          <button
            ...
            className="absolute top-4 right-4 p-2 text-slate-300 hover:text-red-500 hover:bg-red-50 rounded-xl transition-all opacity-0 group-hover:opacity-100 disabled:opacity-80 disabled:cursor-wait"
            title="Delete Person"
          >
            {isDeletingContact ? (
                  ...
                  return (
                    <div key={tx._id} className="bg-white border border-slate-100 rounded-[1.25rem] p-3 sm:p-5 flex items-center justify-between shadow-sm hover:shadow-md transition-all duration-300 group/row relative overflow-hidden">
                      ...
                      <button
                        ...
                        className="absolute top-1 right-2 p-1.5 text-slate-300 hover:text-red-500 transition-all opacity-0 group-hover/row:opacity-100 disabled:opacity-80 disabled:cursor-wait flex items-center justify-center"
                        title="Delete Record"
                      >
                        {deletingTxId === tx._id ? (
