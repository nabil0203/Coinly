...
export default async function DebtsPage() {
  ...
  const totalReceivable = contacts.reduce((acc: number, c: any) => acc + (c.total_receivable || 0), 0);
  const totalDebt = contacts.reduce((acc: number, c: any) => acc + (c.total_debt || 0), 0);
  ...
  return (
    <div className="h-full overflow-y-auto py-6 md:py-12 px-4 md:px-8 max-w-7xl mx-auto space-y-8 md:space-y-12">
